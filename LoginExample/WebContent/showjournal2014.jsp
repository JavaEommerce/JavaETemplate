...
String sqljname =  "select distinct journalname, Info from Journal where publishtime >'2013-12-30' and publishtime < '2014-12-30' ";
            ...
            <div class="well">
						<div class="media">
							...
							<div class="media-body">
								...
								<%
								String sqljvsersion =  "select distinct version , publishtime, journalID from Journal where publishtime >'2013-12-30' and publishtime < '2014-12-30' and journalname ="+"\""+nameresult.getString("journalname")+"\"";
								...
								{%>	
								 <p><a href="Search?JID=<%=versionresult.getString("journalID") %>" target=_blank>Version: <%=versionresult.getString("version")%> &nbsp;&nbsp;&nbsp;&nbsp; Publish time:<%=versionresult.getString("publishtime")%></a> </p>	
