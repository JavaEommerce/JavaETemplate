            ...
            <div class="well">
						<div class="media">
							...
							<div class="media-body">
								...
								<%
								String sqljvsersion =  "select distinct version , publishtime, journalID from Journal where publishtime >'2012-12-30' and publishtime < '2013-12-30' and journalname ="+"\""+nameresult.getString("journalname")+"\"";
