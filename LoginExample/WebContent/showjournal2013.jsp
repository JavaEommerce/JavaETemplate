...
//String sqlStr = "select * from Journal where publishtime >'2012-12-30' and publishtime < '2013-12-30' ";
String sqljname =  "select distinct journalname from Journal where publishtime >'2012-12-30' and publishtime < '2013-12-30' ";
