            ...
            <div class="well">
						<div class="media">
							...
							<div class="media-body">
								...
								<%
								String sqljvsersion =  "select distinct version , publishtime, journalID from Journal where publishtime <'2013-1-1'and journalname ="+"\""+nameresult.getString("journalname")+"\"";
